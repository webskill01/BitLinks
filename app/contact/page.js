        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-16">
            ...
            <div className="bg-white/80 backdrop-blur-sm rounded-xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 text-center group">
              ...
              <Link href="https://github.com/webskill01" target='_blank' className="text-gray-700 hover:text-gray-900 font-semibold transition-colors duration-300">
                Open an Issue
              </Link>
            </div>
              ...
              <div className="space-y-8">
                ...
                <div className="bg-white/80 backdrop-blur-sm rounded-xl p-6 shadow-lg">
                  ...
                  <div className="flex gap-4">
                    <Link href="https://github.com/webskill01" target='_blank' className="w-12 h-12 bg-gray-100 hover:bg-gray-200 rounded-lg flex items-center justify-center transition-colors duration-300 group">
